...
public: // 静的メンバ関数
	...
	/// スプライト生成
	/// </summary>
	static Sprite* Create(UINT texNumber, Vector2 position, Math::Vector4 color = { 1, 1, 1, 1 }, Vector2 anchorpoint = { 0.0f, 0.0f }, bool isFlipX = false, bool isFlipY = false);
...
public: // メンバ関数
	...
	/// コンストラクタ
	/// </summary>
	Sprite(UINT texNumber, Vector2 position, Vector2 size, Math::Vector4 color, Vector2 anchorpoint, bool isFlipX, bool isFlipY);
	/// <summary>
	/// 初期化
	/// </summary>
	bool Initialize();
