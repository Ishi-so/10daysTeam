...
namespace XIIlib
{
	enum GI_FORMAT_DATA
	{
		RGBA_FLOAT = 2,	// DXGI_FORMAT_R32G32B32A32_FLOAT(2)
		RGBA_UINT = 3,	// DXGI_FORMAT_R32G32B32A32_UINT(3)
		RGB_FLOAT = 6,	// DXGI_FORMAT_R32G32B32_FLOAT(6)
		RG_FLOAT = 16,	// DXGI_FORMAT_R32G32_FLOAT(16)
		R_FLOAT = 41	// DXGI_FORMAT_R32_FLOAT(41)
	};
